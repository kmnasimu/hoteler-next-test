                    ...
                    <div className="col-xl-8 col-lg-7 product-details rd-page">
                        ...
                        <div className="bxslider">
                            <div className="slider-content">
                                <figure className="image-box"><Link href="images/resource/room-1.jpg" className="lightbox-image" data-fancybox="gallery"><img src="images/resource/room-1.jpg" alt="" /></Link></figure>
                                <div className="slider-pager">
                                    <ul className="thumb-box">
                                        <li className="mb-0"><Link className="active" data-slide-index="0" href="/"><figure><img src="images/resource/room-1.jpg" alt="" /></figure></Link></li>
                                        <li className="mb-0"><Link data-slide-index="1" href="/"><figure><img src="images/resource/room-2.jpg" alt="" /></figure></Link></li>
                                        <li className="mb-0"><Link data-slide-index="2" href="/"><figure><img src="images/resource/room-4.jpg" alt="" /></figure></Link></li>
                                        <li className="mb-0"><Link data-slide-index="3" href="/"><figure><img src="images/resource/room-2.jpg" alt="" /></figure></Link></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="slider-content">
                                <figure className="image-box"><Link href="images/resource/room-2.jpg" className="lightbox-image" data-fancybox="gallery"><img src="images/resource/room-2.jpg" alt="" /></Link></figure>
                                <div className="slider-pager">
                                    <ul className="thumb-box">
                                        <li className="mb-0"><Link className="active" data-slide-index="0" href="/"><figure><img src="images/resource/room-1.jpg" alt="" /></figure></Link></li>
                                        <li className="mb-0"><Link data-slide-index="1" href="/"><figure><img src="images/resource/room-2.jpg" alt="" /></figure></Link></li>
                            ...
                            <div className="slider-content">
                                <figure className="image-box"><Link href="images/resource/room-4.jpg" className="lightbox-image" data-fancybox="gallery"><img src="images/resource/room-4.jpg" alt="" /></Link></figure>
                                <div className="slider-pager">
                                    <ul className="thumb-box">
                                        <li className="mb-0"><Link className="active" data-slide-index="0" href="/"><figure><img src="images/resource/room-1.jpg" alt="" /></figure></Link></li>
                                        <li className="mb-0"><Link data-slide-index="1" href="/"><figure><img src="images/resource/room-2.jpg" alt="" /></figure></Link></li>
                        ...
                        <div className="room-details__left">
                            <div className="wrapper">
                                ...
                                <p className="text">Unwind in our spacious Hoteler King Room, thoughtfully designed for comfort and relaxation. Featuring a plush king-sized bed, elegant décor, and modern amenities, this room offers the perfect retreat after a day of travel or exploration. Featuring a plush king-sized bed, elegant décor, and modern amenities, this room offers the perfect retreat after a day of travel or exploration.</p>
                                ...
                                <p className="text">Enjoy natural light streaming through large windows, a cozy seating area, and a work-friendly desk. The private en-suite bathroom is equipped with a rain shower, soft towels, and premium toiletries. Enjoy natural light streaming through large windows, a cozy seating area, and a work-friendly desk. The private en-suite bathroom is equipped with a rain shower, soft towels, and premium toiletries.</p>
                            </div>
                            <div className="mt-40">
                            ...
                            <div className="d-sm-flex align-items-sm-center justify-content-sm-between pt-40 pb-40 border-top">
                                ...
                                <div className="blog-details__social-list"> <Link href="room-details"><i className="fab fa-x-twitter" /></Link> <Link href="room-details"><i className="fab fa-facebook" /></Link> <Link href="room-details"><i className="fab fa-pinterest-p" /></Link> <Link href="room-details"><i className="fab fa-instagram" /></Link> </div>
                            </div>
                    ...
                    <div className="col-xl-4 col-lg-5">
                        <div className="sidebar">
                            ...
                            <div className="kodelisting-room-booking-wrap">
                                ...
                                <form className="reservation-form" id="contact_form2" name="contact_form" action="#" method="post">
                                    <div className="row">
                                        <div className="col-sm-12 mb-3">
                                            <div className="form-floating">
                                                <input type="datepicker" name="form_name" className="form-control datepicker" placeholder="Check In" id="" />
                                                <label htmlFor="">Check In</label>
                                            </div>
                                        </div>
                                        <div className="col-sm-12 mb-3">
                                            <div className="form-floating">
                                                <input type="datepicker2" name="form_name" className="form-control datepicker" placeholder="Check Out" id="CheckOut" />
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="checkbox-row">
                                            <label className="checkbox-label custom-checkbox">
                                                <input type="checkbox" name="CarRental" value="Car Rental" />
                                            Car Rental
                                            </label>
                                            <span className="checkbox-price">$10 / Night</span>
                                        </div>
                                        ...
                                        <div className="checkbox-row">
                                            <label className="checkbox-label custom-checkbox">
                                            <input type="checkbox" name="SeaView" value="Sea View" />
                                            Sea View
                                            </label>
                                            <span className="checkbox-price">$10 / Night</span>
                                        </div>
							...
							<ul className="sidebar__post-list list-unstyled">
								<li>
									...
									<div className="sidebar__post-content">
										<h3> <span className="sidebar__post-content-meta"><i className="fas fa-door-open" />Economy Room</span> <Link href="/">$175/Night</Link>
										</h3>
									</div>
								</li>
								<li>
									...
									<div className="sidebar__post-content">
										<h3> <span className="sidebar__post-content-meta"><i className="fas fa-door-open" />Deluxe Room</span> <Link href="/">$250</Link> </h3>
									</div>
								</li>
								<li>
									<div className="sidebar__post-image"> <img src="images/resource/news-info-1.jpg" alt="" /> </div>
									<div className="sidebar__post-content">
										<h3> <span className="sidebar__post-content-meta"><i className="fas fa-door-open" />Super Deluxe Room</span> <Link href="/">$320</Link> </h3>
									</div>
								</li>
							</ul>
						</div>
